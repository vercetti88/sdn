package com.sdn.referral.main.services;
...
public class SmsService {
    ...
    public SmsService(String login, String password) {
        SMSC_LOGIN    = login;
        SMSC_PASSWORD = password;
    }

    public SmsService(String login, String password, String charset) {
        SMSC_LOGIN    = login;
        SMSC_PASSWORD = password;
        SMSC_CHARSET  = charset;
    }

    public SmsService(String login, String password, String charset, boolean debug) {
        SMSC_LOGIN    = login;
        SMSC_PASSWORD = password;
        SMSC_CHARSET  = charset;
        SMSC_DEBUG    = debug;
...
// Examples:
/*
		SmsService sd = new SmsService();
		// or
		SmsService sd = new SmsService("login", "password");
